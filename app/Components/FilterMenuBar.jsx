...
const FilterMenuBar = () => {
  ...
  return (
        <sidebar className="md:h-max h-screen  overflow-y-auto lg:w-[20%] md:z-0 z-50 md:w-[25%] w-[50%] top-[150px] left-0 md:static absolute bg-white shadow-sm rounded-lg p-4">
