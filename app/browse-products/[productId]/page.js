                ...
                <div className='flex flex-col justify-between w-full h-max'>
                        ...
                        {smallimages.map((image, index) => (
                            ...
                            >
                                <img 
                                    src={image} 
                                    alt='product image' 
                                    className={`w-[80px] h-[80px] sm:w-[100px] sm:h-[100px] object-cover cursor-pointer ${selectedImage === image ? 'border-2 border-accent' : ''}`}
                    ...
                    >
                        <img 
                            ...
                            alt='product image' 
                            className={`w-full h-full object-cover transition-transform duration-300 ease-in-out ${isHovering ? 'scale-110' : 'scale-100'}`}
                        />
                    </div>
                </div>
